...
OI::OI() {
	...
	collectSlowerButton = new JoystickButton(driveStick, 8);
	collectSlowerButton->WhileHeld(new collectSlower());
	collectFasterButton = new JoystickButton(driveStick, 7);
	collectFasterButton->WhileHeld(new collectFaster());
	angleDownButton = new JoystickButton(driveStick, 3);
	angleDownButton->WhileHeld(new angleDown());
	angleUpButton = new JoystickButton(driveStick, 4);
	angleUpButton->WhileHeld(new angleUp());
	shiftButton = new JoystickButton(driveStick, 9);
