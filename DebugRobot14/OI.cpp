...
OI::OI() {
	...
	stopDataButton = new JoystickButton(joystick1, 3);
	stopDataButton->WhenPressed(new StopSending());
	...
	SmartDashboard::PutData("StopSending", new StopSending());
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
	sendDataButton = new JoystickButton(joystick1, 1);
