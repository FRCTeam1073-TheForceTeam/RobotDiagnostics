...
DataSending::DataSending() : Subsystem("DataSending") {
	...
	transducers = RobotMap::dataSendingTransducers;
	ultrasonic = RobotMap::dataSendingUltrasonic;
...
void DataSending::SendTheData(){
	...
	Send((bool)RobotMap::launcherLauncherSolenoid1->Get());
	Send((bool)RobotMap::launcherLauncherSolenoid2->Get());
	...
	Send(RobotMap::collectorCollectorJag->GetOutputVoltage());
	...
	Send(RobotMap::collectorCollectorJag->GetOutputCurrent());
	Send(transducers->GetVoltage());
	Send(ultrasonic->GetVoltage());
	Send(drive->GetMatchTime());
	Send(RobotMap::collectorCollectorJag->Get());
